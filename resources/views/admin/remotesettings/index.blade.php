@extends('layouts.panel',['pageName' => 'Remote Settings'])
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{route('panel.remotesettings.ajaxget')}}",
                    type: "POST"
                },
                columns: [
                    { data: 'sort' },
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div>
                                    <h4 class="header-title mb-3">{{$title}} <a href='{{ route('panel.remotesettings.create') }}' type="button" class="btn btn-success new_button" >New Remote</a></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
