    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div>
                        <h4 class="header-title mb-3">{{$title}} -> <a href="{{route('panel.models.edit', ['id' => $model->id, 'type' => 0])}}">{{ $model->name. ' ' .$model->surname}}</a></h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form class="form-horizontal" method='post' action='{{ route('models.poloraid.store', @$model->id) }}' enctype="multipart/form-data">
