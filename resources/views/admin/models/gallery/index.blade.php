    ...
    <script>
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{route('models.gallery.ajaxget', @$model->id)}}",
                    type: "POST"
                },
                columns: [
                    { data: 'sort' },
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div>
                                    <h4 class="header-title mb-3">{{$title}} -> <a href="{{route('panel.models.edit', ['id' => $model->id, 'type' => 0])}}">{{ $model->name. ' ' .$model->surname}}</a> <a href='{{ route('models.gallery.create', @$model->id) }}' type="button" class="btn btn-success new_button" >Yeni Görsel</a></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
