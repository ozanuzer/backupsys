    ...
    <script>
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{route('panel.news.gallery.ajaxget', @$news->id)}}",
                    type: "POST"
                },
                columns: [
                    { data: 'sort' },
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div>
                                    <h4 class="header-title mb-3">{{$title}} <a href='{{ route('panel.news.gallery.create', @$news->id) }}' type="button" class="btn btn-success new_button" >Yeni Görsel</a></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
